...
blueprints.music_loader = game.make_blueprint('music_loader',
  {'transform', pos=v2(1024, 0)},
  {'sprite', resource='loading'},
  {'load_music', filename='audio/music.ogg'})

blueprints.game_flow = game.make_blueprint('game_flow',
  {'game_flow'})

blueprints.fade_in = game.make_blueprint('fade',
...
blueprints.fighter = game.make_blueprint('fighter',
  {'transform'},
  {'sprite'},
...
blueprints.bomber = game.make_blueprint('bomber',
  {'transform'},
  {'sprite'},
...
blueprints.frigate = game.make_blueprint('frigate',
  {'transform'},
  {'sprite'},
...
blueprints.selection_factory = game.make_blueprint('selection_factory',
  {'transform'},
