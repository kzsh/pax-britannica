...
-- harvest_multiplier scales this AI's income, and is the sole difficulty
-- knob. It is supplied by the blueprint (see blueprints.lua); default to the
-- medium setting if a blueprint forgets to pass one.
harvest_multiplier = harvest_multiplier or 1.0
self.resources.harvest_rate = self.resources.harvest_rate * harvest_multiplier
